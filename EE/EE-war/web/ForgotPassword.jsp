...
<html>
    ...
    <body>
        ...
        <form action="ForgotPassword" method="POST" class="block">
                    ...
                    <div class="w-full lg:w-6/12 px-4 pt-20">
                        <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-100 border-0">
                            <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                                <div class="text-gray-500 text-center mb-3 mt-1 text-xl font-bold">
                                    <small>Send Reset Password Link</small>
                                </div>
                                ...
                                <form>
                                    ...
                                    <div class="text-center mt-6">
                                        <input type="submit" value="Send Reset Password Link" class="bg-gray-900 text-white active:bg-gray-700 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full" type="button" style="transition: all 0.15s ease 0s;"/>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="flex flex-wrap mt-6">
                            ...
                            <div class="w-1/2 text-right">
                                <a href="Register.jsp" class="text-gray-500">
