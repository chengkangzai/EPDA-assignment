...
public class MyOrder extends Model implements Serializable {
    ...
    public String toTd(MyUser user) {
        return "<tr>"
                ...
                + ((this.getDelivery() == null || this.getDelivery().getStatus() == Delivery.Status.PENDING) && user.can("Update Order") ? "<a class='btn btn-sm btn-accent' href='/EE-war/Orders/Edit?id=" + this.getId() + "'>Add on</a>" : "")
